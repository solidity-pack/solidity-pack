...
contract ERC20 is IERC20, SuperOwner {
    ...
    mapping (address => bool) private _blackList; //List Address for stop transaction Smart Contract
    mapping (address => bool) private _admin; // List Admin for work to stop the transaction
    bool _pause = false; // Stop all transaction, if _pause = true
...
contract TokenERC20 is ERC20, ERC20Detailed {
    uint private INITIAL_SUPPLY = 1000000e18; //1000000e18 = 1 Million Token (Supply) * e18 (Decimals Token)
    constructor () public
    ERC20Detailed("Basic Token", "BST", 18) {
